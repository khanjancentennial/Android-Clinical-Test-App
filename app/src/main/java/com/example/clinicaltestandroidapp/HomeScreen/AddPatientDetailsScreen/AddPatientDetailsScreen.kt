...
import com.example.clinicaltestandroidapp.HomeScreen.AddPatientDetailsScreen.AddPatientDetailsViewModel
import com.example.clinicaltestandroidapp.RegistrationScreen.RegistrationViewModel

@Composable
fun AddPatientDetailsScreen(navController: NavController) {
...
//    val sharedPreferences = context.getSharedPreferences("your_shared_prefs_name", Context.MODE_PRIVATE)
    ...
    val viewModel: AddPatientDetailsViewModel = viewModel()
