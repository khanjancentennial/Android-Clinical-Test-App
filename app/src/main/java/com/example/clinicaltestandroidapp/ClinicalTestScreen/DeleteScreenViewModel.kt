...
class DeleteClinicalTestViewModel : ViewModel() {
    ...
    fun deletePatient(testId: String, completion: (Boolean) -> Unit) {
        _isLoading.value = true

        viewModelScope.launch(Dispatchers.IO) {
            val urlString = "https://group3-mapd713.onrender.com/api/clinical-tests/clinical-tests/$testId"
